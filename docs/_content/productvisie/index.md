...
Door VNG Realisatie wordt de logging API-standaard ontwikkeld. Met deze API-standaard wordt de wijze waarop de verwerking van gegevens van een object worden vastgelegd en ontsloten gestandaardiseerd. Een object kan hierbij een persoon zijn maar ook een kadastraal object. Vanuit deze logging is navolgbaar voor welk doel de gemeente gegevens heeft gebruikt binnen de gemeentelijke processen. Het doel van de API-standaard, en daarmee de vastlegging van verwerkingen in een logregistratie is het navolgbaar maken van verwerkingen van gegevens van objecten. Ten aanzien van de verwerking van persoonsgegevens is hierbij het perspectief van de burger leidend. Het moet vanuit de vastlegging van de verwerkingen voor de burger duidelijk zijn:
- wat er met zijn of haar gegevens is gedaan, en 
- waarom de gegevens verwerkt zijn. 

Het doel van de vastlegging van verwerkingen is niet om reconstructies te kunnen maken van situaties en gegevens in systemen op een bepaald tijdstip in het verleden. Het is de bedoeling om te kunnen 'duiden' wat er gebeurd is. Mocht de burger naar aanleiding van de gepresenteerde duiding van verwerkingen nadere vragen hebben dan kunnen eventuele 'forensische' onderzoeken worden uitgevoerd bij de applicaties die de gegevens daadwerkelijk hebben verwerkt.
