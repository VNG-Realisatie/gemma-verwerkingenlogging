...
-	Wijzigingen moeten traceerbaar zijn
    - Van logentries moet formele historie bijgehouden worden
...
- Tijdstip registratie: Tijdstip waarop de entry in het log is opgeslagen. Bepaald door het log, niet door de loggende applicatie.
- Vervallen: `Ja` of `Nee`.

### Toelichting op de inhoud:
- Het log toont op deze manier altijd de laatste situatie.
