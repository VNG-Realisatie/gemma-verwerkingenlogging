...
* Er is geen overheidsbrede standaard voor logging. Hierdoor is het onwaarschijnlijk dat de manier waarop de gemeenten het verwerkingsactiviteitenregister hebben ingericht (velden en definities) en er naar verwijzen zondermeer bruikbaar is voor de RDW.
