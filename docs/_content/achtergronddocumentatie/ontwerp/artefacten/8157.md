...
-	Bij het aanroepen van API’s n.a.v. een verwerking dient het UUID van de verwerking meegegeven te worden. Dit UUID wordt door de provider van de API gelogd in [Verwerking afnemer](../../../gegevenswoordenboek/attributen/Verwerking_afnemer.md).
