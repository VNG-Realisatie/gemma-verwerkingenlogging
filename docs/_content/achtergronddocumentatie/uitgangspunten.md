...
Er is verder gekozen om een systeem te hanteren waarbij bestaande APIs niet 'opengebroken' hoeven te worden om de voor verwerkingenlogging benodigde attributen mee te geven. Besloten is om de payload van bestaande APIs niet te wijzigen en lverwerkingenlogging attributen via http header attributen mee te geven. Zie [B9177: Meegeven van informatie t.b.v. verwerkingenlogging in API’s](./ontwerp/artefacten/9177.md) voor een nadere uitleg.
