...
Bij het ontwerp van de API-standaard is gebruik gemaakt van een aantal [brondocumenten](../achtergronddocumentatie/definition_of_done). Deze brondocumenten zijn de basis van het ontwerp van de API-standaard.
