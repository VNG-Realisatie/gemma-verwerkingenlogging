...
De volledige documentatie van de API-standaard is via de standaard Github navigatie beschikbaar via [deze link](./docs/index.md) maar kan ook via een [gebruiksvriendelijke interface](https://vng-realisatie.github.io/gemma-verwerkingenlogging/) worden benaderd.
